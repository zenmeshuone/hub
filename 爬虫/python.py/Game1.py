...
while running:
	...
	playerrot = pygame.transform.rotate(rabbit_img, 360-angle*57.45)
	...
	survivedtext = font.render(str((180000-pygame.time.get_ticks())//60000)+":"+
							   str((180000-pygame.time.get_ticks())//1000%60).zfill(2), True, (0,0,0))
